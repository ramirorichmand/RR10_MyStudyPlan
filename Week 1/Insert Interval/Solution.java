...
class Solution {
    public int[][] insert(int[][] intervals, int[] newInterval) {   
       // initialise an ArrayList to hold the merged intervals
        ArrayList<int[]> ans = new ArrayList<>();
        // initialise a variable to track our position in the input intervals array
        int idx = 0;
...
// !! Made the first while loop shorter !! \\
